                    ...
                    Item {
                        ...
                        RowLayout { // Content
                            ...
                            RippleButton {
                                ...
                                Layout.leftMargin: Appearance.rounding.screenRounding <= 23 ? 23 : Appearance.rounding.screenRounding
                    ...
                    Item {
                        ...
                        RowLayout {
                            ...
                            RippleButton { // Right sidebar button
                                ...
                                Layout.margins: 4
                                Layout.rightMargin: Appearance.rounding.screenRounding <= 23 ? 23 : Appearance.rounding.screenRounding
                                Layout.fillHeight: true
                                implicitWidth: indicatorsRowLayout.implicitWidth + 10 * 2
                                buttonRadius: Appearance.rounding.full
                                colBackground: barRightSideMouseArea.hovered ? Appearance.colors.colLayer1Hover : ColorUtils.transparentize(Appearance.colors.colLayer1Hover, 1)
                                colBackgroundHover: Appearance.colors.colLayer1Hove
                                colRipple: Appearance.colors.colLayer1Active
                                colBackgroundToggled: Appearance.colors.colSecondaryContainer
                                colBackgroundToggledHover: Appearance.colors.colSecondaryContainerHover
                                colRippleToggled: Appearance.colors.colSecondaryContainerActive
