...
Singleton {
    ...
    font: QtObject {
        property QtObject family: QtObject {
            ...
            property string title: "Roboto"
            property string iconMaterial: "Material Symbols Rounded"
            property string iconNerd: "FantasqueSansM Nerd Font"
            property string monospace: "FantasqueSansM Nerd Font"
